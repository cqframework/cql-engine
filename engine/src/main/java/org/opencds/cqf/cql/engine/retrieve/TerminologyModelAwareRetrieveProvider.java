...
public abstract class TerminologyModelAwareRetrieveProvider implements ModelEnrichedRetrieveProvider {
    ...
    public TerminologyModelAwareRetrieveProvider setExpandValueSets(boolean expandValueSets) {
