...
public class ProperlyIncludedInEvaluator extends ProperIncludedIn {
  ...
  public Object evaluate(Context context) {
    ...
    if (left != null && right != null) {
      ...
      return (Value.compareTo(Interval.getSize(leftStart, leftEnd), Interval.getSize(rightStart, rightEnd), "!=") && Value.compareTo(rightStart, leftStart, "<=") && Value.compareTo(rightEnd, leftEnd, ">="));
    }
    return null;
  }
}
