...
public class GreaterOrEqualEvaluator extends GreaterOrEqual {
  ...
  public static Object greaterOrEqual(Object left, Object right) {
    ...
    // >(DateTime, DateTime)
      ...
      return leftDT.getPartial().getValue(size-1) >= rightDT.getPartial().getValue(size-1);
    }
    ...
    throw new IllegalArgumentException(String.format("Cannot GreaterOrEqual arguments of type '%s' and '%s'.", left.getClass().getName(), right.getClass().getName()));
  }
