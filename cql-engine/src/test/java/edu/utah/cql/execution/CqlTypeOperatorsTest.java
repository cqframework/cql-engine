...
public class CqlTypeOperatorsTest extends CqlExecutionTestBase {
    ...
    /**
     * {@link edu.utah.cql.elm.execution.As#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Convert#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Is#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.ToBoolean#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.ToConcept#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.ToDateTime#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.ToDecimal#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.ToInteger#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.ToQuantity#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.ToString#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.ToTime#evaluate(Context)}
     */
    @Test
