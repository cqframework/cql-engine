package edu.utah.cql.execution;
...
public class CqlListOperatorsTest extends CqlExecutionTestBase {
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Contains#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Distinct#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Equal#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Except#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Exists#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Flatten#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.First#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.In#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Includes#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.IncludedIn#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Indexer#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.IndexOf#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Intersect#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Last#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Length#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Equivalent#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.NotEqual#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.ProperIncludes#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.ProperIncludedIn#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.SingletonFrom#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Union#evaluate(Context)}
     */
    @Test
