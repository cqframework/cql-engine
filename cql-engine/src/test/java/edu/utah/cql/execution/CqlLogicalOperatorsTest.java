...
public class CqlLogicalOperatorsTest extends CqlExecutionTestBase {
    ...
    /**
     * {@link edu.utah.cql.elm.execution.And#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Implies#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Not#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Or#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Xor#evaluate(Context)}
     */
    @Test
