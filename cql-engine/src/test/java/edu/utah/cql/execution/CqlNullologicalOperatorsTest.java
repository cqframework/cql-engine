...
public class CqlNullologicalOperatorsTest extends CqlExecutionTestBase {
    ...
    /**
     * {@link edu.utah.cql.elm.execution.Coalesce#evaluate(Context)}
     */
    @Test
    public void testCoalesce() throws JAXBException {
        Context context = new Context(library);
        Object result = context.resolveExpressionRef(library, "CoalesceANull").getExpression().evaluate(context);
    ...
    /**
     * {@link edu.utah.cql.elm.execution.IsNull#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.IsFalse#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.IsTrue#evaluate(Context)}
     */
    @Test
