...
import edu.utah.cql.elm.execution.CalculateAgeAtEvaluator;
...
public class CqlClinicalOperatorsTest extends CqlExecutionTestBase {
    ...
    /**
     * {@link edu.utah.cql.elm.execution.CalculateAge#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.CalculateAgeAt#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.InCodeSystem#evaluate(Context)}
     */
    @Test
    ...
    /**
     * {@link edu.utah.cql.elm.execution.ValueSetDef#evaluate(Context)}
     */
    @Test
