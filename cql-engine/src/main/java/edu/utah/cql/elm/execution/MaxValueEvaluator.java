...
public class MaxValueEvaluator extends org.cqframework.cql.elm.execution.MaxValue {
    ...
    public Object evaluate(Context context) {
        switch (valueType.getLocalPart()) {
            case "Integer": return edu.utah.cql.runtime.Interval.maxValue(Integer.class);
            case "Decimal": return edu.utah.cql.runtime.Interval.maxValue(BigDecimal.class);
            case "Quantity": return edu.utah.cql.runtime.Interval.maxValue(edu.utah.cql.runtime.Quantity.class);
            case "DateTime": return edu.utah.cql.runtime.Interval.maxValue(DateTime.class);
            case "Time": return edu.utah.cql.runtime.Interval.maxValue(Time.class);
