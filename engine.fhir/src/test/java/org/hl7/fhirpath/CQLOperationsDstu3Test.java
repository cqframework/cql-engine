...
public class CQLOperationsDstu3Test extends TestFhirPath implements ITest {
    ...
    public static Set<String> SKIP = Sets.newHashSet(
        "stu3/tests-fhir-r3/Dollar/testDollarOrderNotAllowed",
        "stu3/tests-fhir-r3/Dollar/testDollarThis1",
        "stu3/tests-fhir-r3/Dollar/testDollarThis2",
        "stu3/tests-fhir-r3/Literals/testLiteralDate2",
        "stu3/tests-fhir-r3/Literals/testLiteralDate3",
        "stu3/tests-fhir-r3/Literals/testLiteralDate4",
        "stu3/tests-fhir-r3/Literals/testLiteralDate5",
        "stu3/tests-fhir-r3/Literals/testLiteralDate6",
        "stu3/tests-fhir-r3/Literals/testLiteralDate7",
        ...
        "stu3/tests-fhir-r3/Literals/testLiteralUnicode",
